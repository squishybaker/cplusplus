// Ch4-01-cannedFunctionsAndTypes.cpp : Defines the entry point for the console application.
//

// TODO Initialize pow, sqrt functions
...
int main()
{
    ...
    cout << "int " << int1 << " / "
         << "int " << int2;
    cout << " = " << double1 << endl;
    // static_cast of result does no good, it is already chopped off asan int
        double1 = static_cast<double>(int1 / int2);
    cout << "static_cast<double> (int " << int1 << " / "
         << "int " << int2;
    cout << ") = " << double1 << endl;
